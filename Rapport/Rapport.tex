...
Systemet er dog ikke begrænset til små biografer og kan derfor også bruges af større biografer med store sale. Det har vi valgt at gøre 
...
\chapter{Konklusion}
Gennem Java har vi opbygget et simpelt program der bygger på \emph{Model View Controller}. Vores \emph{Model}, som er vores brugergrænseflade, er skabt primært i JavaFx, og der har designmæssigt være fokus på \cite{Java} brugervenlighed. 
